...
function preload()
{
  ...
  arrow = loadImage('arrowclipart.png')
  arrow2 = loadImage('arrowclipart2.png')
...
function setup() {
  ...
  //arrow sprites
  arrowButton = createImg('arrowclipart.png')
  arrowButton.position(50,600)
  arrowButton.size(150,150)
  arrowButton.mouseClicked(blow)

  arrow2Button = createImg('arrow2clipart.png')
  arrow2Button.position(200,600)
  arrow2Button.size(150,150)
  arrow2Button.mouseClicked(blow2)
